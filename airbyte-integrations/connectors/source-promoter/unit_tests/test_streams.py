...
import pytest
from source_promoter.source import PromoterStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PromoterStream, "path", "v0/example_endpoint")
    mocker.patch.object(PromoterStream, "primary_key", "test_primary_key")
    mocker.patch.object(PromoterStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = PromoterStream()
